 ...
 * Use the [PhotoGalleryImageFragment.newInstance] factory method to
...
class PhotoGalleryImageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PhotoGalleryImageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PhotoGalleryImageFragment().apply {
